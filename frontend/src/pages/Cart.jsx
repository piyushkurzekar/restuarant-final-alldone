...
const Cart = () => {
  ...
  const fetchCartOrders = async () => {
    try {
      const res = await fetch("https://restuarant-final-alldone.onrender.com/api/orders/cart");
  ...
  const handleConfirmOrder = async (order) => {
    ...
    try {
      const res = await fetch(`https://restuarant-final-alldone.onrender.com/api/orders/confirm/${order.id}`, {
        method: "PATCH",
  ...
  const handleCompleteOrder = async () => {
    ...
    try {
      const res = await fetch(
        `https://restuarant-final-alldone.onrender.com/api/orders/complete/${selectedOrder.id}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
